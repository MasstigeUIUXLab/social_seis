...
var d={placeholder:"선택",// Dont change it here.
csvDispCount:3,// display no. of items in multiselect. 0 to display all.
captionFormat:"{0}개 선택",// format of caption text. you can set your locale.
captionFormatAllSelected:"{0} 모두 선택",// format of caption text when all elements are selected. set null to use captionFormat. It will not work if there are disabled elements in select.
...
searchText:"검색...",// placeholder for search input
searchFn:function searchFn(a,b){// search function
return 0>a.toLowerCase().indexOf(b.toLowerCase())},noMatch:"No matches for \"{0}\"",prefix:"",// some prefix usually the field name. eg. '<b>Hello</b>'
locale:["선택","취소","전체","모두 취소"],// all text that is used. don't change the index.
